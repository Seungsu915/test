	...
	<div class="well well-lg">
		<form class="form-horizontal" id="boardRegForm" name="boardRegForm"
			...
			<div class="form-group">
				...
				<input type="hidden" id="boardId" name="boardId" value="${sessionScope.boardId }"> 
				<input type="hidden" id="groupId" name="groupId" value="${sessionScope.groupId }">
				...
				<div class="col-sm-10 control-label" style="text-align: left;">
					<input type="hidden" class="form-control" id="writer" name="writer"
						...
						style="float: left; width: 40%" value=${boardVO.id }> 
