...
<div class="container">
	...
	<c:forEach var="result" items="${resultList}" varStatus="status">
		<div class="well well-sm">
			<c:out value="${result.name}" />/<fmt:formatDate value="${result.indate}" pattern="yyyy-MM-dd hh:mm:ss" />
			<br />
	...
	<div class="well well-lg">
		<form class="form-horizontal" id="formReply" name="formReply" method="post" action="">
			<div class="form-group">
				<input type="hidden" name="idx" value="${boardVO.idx}" /> 
				<input type="hidden" name="boardId" value="${sessionScope.boardId}" /> 
